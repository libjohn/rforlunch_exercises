...
\
Modele how R can work for practical reproducible workflows

-   Code in RStudio

-   One kind of report are these slides ([GitHub](https://github.com/libjohn/rforlunch_exercises/tree/main))
...
-   Independently and transparently you can achieve reliable results with the same data and the same workflow
-   Best way to be transparent with your work is to make sure it can be reproduced
...
-   A scientific publishing workflow
    -   dashboards, manuscripts, MSWord, slides, website, e-book, PDF
-   **Coding Notebooks**: structure our code interspersed with explanatory text. When combined and run, will generate reproducible reports that can be shared.
