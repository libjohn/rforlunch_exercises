...
-   Demo a Quarto Manuscript
    ...
    -   **BUILD** `quarto render` [(**Render** Proejct)]{style="color: grey; font-size: x-large;"}
    -   `_quarto.yaml` [ - -  Example at Quarto documentation](https://quarto.org/docs/authoring/front-matter.html){style="color: grey; font-size: x-large;"}
...
-   Use **RStudio Project** protocol 
    ...
    -   Link GitHub to Zenodo to mint DOIs and archive milestones
...
-   [Quarto documentation on Manuscripts](%5BQuarto%20Manuscripts%20–%20Quarto%5D(https://quarto.org/docs/manuscripts/))

## Hands-on

Make a new RStudio project - choose WebSite

[Directions](https://mine-cetinkaya-rundel.github.io/quarto-jsm24/4-manuscripts/4-manuscripts.html#/getting-started) from Çetinkaya-Rundel & Wickham
